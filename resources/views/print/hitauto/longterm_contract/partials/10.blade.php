    ...
    <tbody>
        ...
        <tr>
            <td>
                ...
                PIB: {{$databag->company_info->acCode}} (u daljem tekstu: Zakupodavac) koga zastupa Zoran Dragoj,
                direktor
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                ...
                @else JMBG: {{$databag->subject->acCode}} @endif
        ...
        <tr>
            <td class="indent">
                ...
                račun Zakupodavca kod OTP Banke Srbije broj 275-220013667-03.
            </td>
        </tr>
