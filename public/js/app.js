...
function Report(data) {
  ...
  this.page = dom_parser.parseFromString(data.page, "text/html").body.firstChild; // this.nodes = data.nodes.map(node => {
  ...
  this.get_element_height = function (id) {
    var base_element = this.nodes[id];
    var element = base_element.cloneNode(true);
    var page_for_measure = this.page.getElementById("page").cloneNode(true);
    ...
    height += parseInt(window.getComputedStyle(dom_element).getPropertyValue("margin-top"));
    height += parseInt(window.getComputedStyle(dom_element).getPropertyValue("margin-bottom")); //   document.body.removeChild(dom_element);
  ...
  this.get_page_height = function () {
    var base_element = this.page.getElementById("page");
    var element = base_element.cloneNode(true);
    ...
    var header_margina_bottom = parseInt(window.getComputedStyle(header).getPropertyValue("margin-bottom"));
    ...
    var footer_margin_bottom = parseInt(window.getComputedStyle(footer).getPropertyValue("margin-bottom"));
  ...
  this.test = function (id) {
    var base_element = this.nodes[id];
    var element = base_element.cloneNode(true);
    var page_for_measure = this.page_content.getElementById("page").cloneNode(true);
    document.body.appendChild(page_for_measure);
    var content_node_for_measure = page_for_measure.querySelector("#content");
    var dom_element = content_node_for_measure.appendChild(element);
    var top = window.getComputedStyle(dom_element).getPropertyValue("margin-top");
    var bottom = window.getComputedStyle(dom_element).getPropertyValue("margin-bottom"); //   console.log("margine height", top);
    //   console.log("margine height", bottom);
    // var dom_element = document.body.appendChild(element);

    var height = dom_element.offsetHeight;
    height += parseInt(window.getComputedStyle(dom_element).getPropertyValue("margin-top"));
    height += parseInt(window.getComputedStyle(dom_element).getPropertyValue("margin-bottom"));
    var height_from_loop = Array.from(element.rows).map(function (row, map_index) {
  ...
  this.mount_nodes = function () {
    //drugi deo renderovanje nodova
    //var uveden zbog footer reda
    var page_count = this.elements.map(function (el) {
      return el.page;
    }).reduce(function (a, b) {
      return Math.max(a, b);
    });
    ...
    for (var i = 1; i <= page_count; i++) {
      var _elements = elements.filter(function (element) {
        return element.page == i;
      });

      page = this.page.getElementById("page").cloneNode(true);
      page.innerHTML = page.innerHTML.replace("#strana#", i);
      var content_node = page.querySelector("#content");

      _elements.map(function (element) {
        // broj strane
        element.node.innerHTML = element.node.innerHTML.replace("#strana#", i); //   console.log(_new_element);
  ...
  this.render_report = function () {
    this.parse_nodes();
    this.mount_nodes();
  };

  this.mount_page = function () {
    var page = this.page.getElementById("page").cloneNode(true);
    document.body.appendChild(page);
  };
}
